...
<head>
  ...
  <script src="vistas/dist/js/adminlte.min.js"></script>
    ...
    <script src="vistas/Calender/fullcalendar.min.js"></script>
    <script src="vistas/Calender/jquery-ui.min.js"></script>
    <script src="vistas/Calender/moment.min.js"></script>

    <link rel="icon" href="vistas/img/plantilla/f.png">
...
<body background="img/plantilla/fondo.jpg" class="hold-transition skin-blue sidebar-collapse sidebar-mini login-page" >
  ...
  if(isset($_SESSION["iniciarSesion"]) && $_SESSION["iniciarSesion"] == "ok"){
   ...
   echo '<div class="wrapper">';
    ...
    =============================================*/
    // if(isset($_GET["url"])){
    //   if($_SESSION['id_rol']) && $_SESSION['id_rol'] == "4" {
    //     if($_GET["url"]){
